    ...
    <div className="flex flex-col items-center justify-center">
      <div className="flex max-sm:flex-col gap-10">
        ...
        <AnimatePresence>
          ...
          <motion.div
  className={`w-[300px] h-[412px] cursor-pointer shadow-2xl rounded-lg flex items-center justify-center transition-colors duration-600 ${
  ...
  {flippedBlueCard ? (
    ...
    />
        ...
        <div className="flex items-center justify-center flex-col gap-5">
          ...
          <motion.div
  className={`w-[300px] h-[412px] cursor-pointer shadow-2xl rounded-lg flex items-center justify-center transition-colors duration-600 ${
    flippedBlueCard ? "bg-[#F55F56] p-10" : ""
  } 
  max-sm:w-[220px] max-sm:h-[310px]`}
  initial={{ rotateY: 0 }}
  animate={{
